<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/webstore.Master" AutoEventWireup="true" CodeBehind="DetalleArticulo.aspx.cs" Inherits="WebStore.Presentacion.DetalleArticulo" %>
 ...
 <div id="container" class="clear">    
    ...
    <article>
        <table>
            <tr>
            <td>
            <figure><img src="images/articulos/2.jpg" width="260" height="260" alt=""></figure>
            </td>
            <td>
                ...
                <p class="more"><asp:Button ID="btnComprar" runat="server" Text="Comprar Ahora" onclick="btnComprar_Click" /></p>
            </td>
            </tr>
        </table>
    </article>
